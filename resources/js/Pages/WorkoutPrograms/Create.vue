                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input v-model="form.name" type="text" class="form-control"
                                ...
                                placeholder="Например: Тренировка на спину" />
                        ...
                        <div class="mb-3">
                            ...
                            <div v-if="form.errors.level" class="invalid-feedback">{{ form.errors.level }}</div>
                        </div>
